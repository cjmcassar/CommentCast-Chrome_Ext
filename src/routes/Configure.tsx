	...
	return (
		...
		<div className="bg-white rounded px-14 pt-4 pb-8 mb-4">
			<div className="main-header">
				<div className="text-3xl font-bold mb-4">Path Configuration</div>
				<div className="mb-4">
					<p>Track the path to identify localization issues.</p>
				</div>
			</div>
				...
				<div className=" flex justify-center mb-6 space-x-2">
					<a href="#_" className="relative inline-block text-lg group">
						<span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
							...
							<span className="relative">New Path</span>
						</span>
						<span
			...
			<div className="recent-scans border-t-2 border-gray-200 pt-4 mb-2">
				<strong className="text-xlg ">Paths</strong>
				<div className="relative flex flex-col text-gray-700 bg-white shadow-md w-50 rounded-xl bg-clip-border mt-4">
					<nav className="flex min-w-[240px] flex-col gap-1 p-2 pr-8 font-sans text-base font-normal text-blue-gray-700">
						<div
							role="button"
			...
			<div className="setting">
				...
				<div className=" flex justify-center mt-4 mb-6 space-x-2">
					<Link to="/languages" className="relative inline-block text-lg group">
						<span className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
							<span className="absolute inset-0 w-full h-full px-5 py-3 rounded-lg bg-gray-50"></span>
							<span className="absolute left-0 w-48 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-gray-900 group-hover:-rotate-180 ease"></span>
